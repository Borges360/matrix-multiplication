...
//        executeMatrix.averageV3(matrix1, matrix2, matrixSize);
        System.out.println(executeMatrix.compareMatrixs(executeMatrix.averageV2(matrix1, matrix2, matrixSize), executeMatrix.averageV3(matrix1, matrix2, matrixSize), matrixSize));
