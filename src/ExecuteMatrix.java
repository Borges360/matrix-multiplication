...
public class ExecuteMatrix {
    ...
    private final MatrizMultiplicationV5 matrizMultiplicationV5;
    ...
    public ExecuteMatrix() {
        ...
        this.matrizMultiplicationV5 = new MatrizMultiplicationV5();
...
//            System.out.println("Tempo de execução algoritmo 4.1 - " + i + ": " + (stopTime - startTime)/1000);
    ...
    public int[][] averageV5(int[][] matrix1, int[][] matrix2, int matrixSize) {
        int[][] matrix = new int[matrixSize][matrixSize];
        ...
        for (int i = 0; i < EXECUTIONS; i++) {
            double startTime = System.currentTimeMillis();
            matrix = matrizMultiplicationV5.calculate(matrix1, matrix2, matrixSize);
            double stopTime = System.currentTimeMillis();
            media = media + (stopTime - startTime) / 1000;
            System.out.println("Tempo de execução algoritmo 5 - " + i + ": " + (stopTime - startTime) / 1000);
        }
        media = media / EXECUTIONS;
        averageTimeExecution.put("Algoritmo 5", media);
//        System.out.println("Algoritmo 5 média de " + EXECUTIONS + " execução: " + media + " segundos");
        return matrix;
    }
